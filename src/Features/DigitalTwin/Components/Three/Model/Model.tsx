...
import { createCardioMaterial, createBodyMaterial } from "./Utils/materialUtils";
...
function Model({
  ...
  const bodyModel = useLoader(OBJLoader, "/src/assets/models/normal/normal.obj");
  const cardioModel = useLoader(OBJLoader, "/src/assets/models/cardio/cardio.obj");
  ...
  const { currentPosition, currentScale, updateTransforms } = useModelTransforms(position, scale);
